...
const PROJECTS = [
  ...
  },
  {
    ...
    categoryId: 'corporate',
    title: 'Uventer',
    description: 'A clear process. Five steady steps for business conferences.',
    image: '/assets/uventer.png',
  ...
  },
  {
    ...
    categoryId: 'ai',
    title: 'Special',
    description: 'Transforming critical American industries with AI.',
