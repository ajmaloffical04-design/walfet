...
export default function WebDevelopment() {
  return (
    <section
      id="web-development"
      className="relative grid min-h-screen grid-cols-1 lg:grid-cols-2 overflow-hidden text-white font-sans bg-black"
    >
      {/* LEFT SIDE */}
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at bottom, #1b4f9a 0%, #06111f 45%, #000 100%)",
        }}
      >
        <div className="max-w-[620px] w-full">
          {/* Headline */}
          <h2 className="text-5xl lg:text-[78px] leading-[0.95] font-light tracking-[-2px] lg:tracking-[-3px] mb-7">
            Modern{" "}
            <span className="text-[#7ea8d9]">web development</span>
          ...
          <p className="text-lg lg:text-[20px] leading-[1.7] text-[#c7d2e0] max-w-[580px] mb-11 font-light">
            We build fast, scalable, and visually stunning websites for brands,
            startups, and businesses focused on performance, user experience, and
